...
ALTER TABLE orders ADD COLUMN average_price decimal DEFAULT 0;
ALTER TABLE orders ADD COLUMN exchange_timestamp TIMESTAMP;
...
ALTER TABLE orders DROP COLUMN average_price; 
ALTER TABLE orders DROP COLUMN exchange_timestamp; 
