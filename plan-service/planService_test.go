...
import (
	...
	testAnalytics "github.com/asciiu/gomo/analytics-service/test"
...
func setupService() (*PlanService, *user.User, *protoAccount.Account) {
	...
	planService := PlanService{
		...
		AnalyticsClient: testAnalytics.MockAnalyticsServiceClient(db),
...
func TestSuccessfulOrderPlan(t *testing.T) {
	...
	assert.Equal(t, "USDT", res.Data.Plan.UserCurrencySymbol, "base currency is expected to default to USDT")
...
func TestOrderUpdatePlan(t *testing.T) {
	...
	assert.Equal(t, 70.0, res.Data.Plan.CommittedCurrencyAmount, "committed currency amount after update order incorrect")
