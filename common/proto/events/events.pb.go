...
type CompletedOrderEvent struct {
	...
	TriggeredPrice     float64 `protobuf:"fixed64,6,opt,name=triggeredPrice" json:"triggeredPrice,omitempty"`
	TriggeredCondition string  `protobuf:"bytes,7,opt,name=triggeredCondition" json:"triggeredCondition,omitempty"`
	ExchangeOrderID    string  `protobuf:"bytes,8,opt,name=exchangeOrderID" json:"exchangeOrderID,omitempty"`
	ExchangeMarketName string  `protobuf:"bytes,9,opt,name=exchangeMarketName" json:"exchangeMarketName,omitempty"`
...
var fileDescriptor0 = []byte{
	...
	,
}
