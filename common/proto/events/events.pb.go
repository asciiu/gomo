...
type CompletedOrderEvent struct {
	...
	TriggeredPrice           float64 `protobuf:"fixed64,16,opt,name=triggeredPrice" json:"triggeredPrice,omitempty"`
	TriggeredCondition       string  `protobuf:"bytes,17,opt,name=triggeredCondition" json:"triggeredCondition,omitempty"`
	ExchangeOrderID          float64 `protobuf:"fixed64,18,opt,name=exchangeOrderID" json:"exchangeOrderID,omitempty"`
...
func (m *CompletedOrderEvent) GetExchangeOrderID() float64 {
	if m != nil {
...
var fileDescriptor0 = []byte{
	...
	0x25, 0x6e, 0xc2, 0x3a, 0x73, 0x0e, 0xfd, 0x52, 0xea, 0x67, 0x66, 0x32, 0xef, 0x33, 0xf4, 0x6d,
	...
	0x00, 0xff, 0xff, 0xdb, 0xab, 0x8c, 0xe2, 0x51, 0x0b, 0x00, 0x00,
}
