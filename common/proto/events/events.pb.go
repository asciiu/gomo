...
type CompletedOrderEvent struct {
	...
	Quantity           float64 `protobuf:"fixed64,7,opt,name=quantity" json:"quantity,omitempty"`
	TriggeredPrice     float64 `protobuf:"fixed64,8,opt,name=triggeredPrice" json:"triggeredPrice,omitempty"`
	TriggeredCondition string  `protobuf:"bytes,9,opt,name=triggeredCondition" json:"triggeredCondition,omitempty"`
	...
	Details            string  `protobuf:"bytes,13,opt,name=details" json:"details,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
