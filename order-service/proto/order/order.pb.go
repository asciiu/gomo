...
func (m *OrderRequests) Reset()                    { *m = OrderRequests{} }
func (m *OrderRequests) String() string            { return proto.CompactTextString(m) }
func (*OrderRequests) ProtoMessage()               {}
func (*OrderRequests) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }

func (m *OrderRequests) GetOrders() []*OrderRequest {
	if m != nil {
		return m.Orders
	}
	return nil
...
type OrderRequest struct {
	...
	NextOrderId      string  `protobuf:"bytes,11,opt,name=nextOrderId" json:"nextOrderId,omitempty"`
}
...
func (m *OrderRequest) GetNextOrderId() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*OrderRequests)(nil), "go.micro.srv.order.OrderRequests")
...
type OrderServiceClient interface {
	AddOrders(ctx context.Context, in *OrderRequests, opts ...client.CallOption) (*OrderListResponse, error)
...
func (c *orderServiceClient) AddOrders(ctx context.Context, in *OrderRequests, opts ...client.CallOption) (*OrderListResponse, error) {
...
type OrderServiceHandler interface {
	AddOrders(context.Context, *OrderRequests, *OrderListResponse) error
...
func (h *OrderService) AddOrders(ctx context.Context, in *OrderRequests, out *OrderListResponse) error {
...
var fileDescriptor0 = []byte{
	...
	,
}
