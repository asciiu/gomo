...
type OrderRequest struct {
	...
	Price            float64 `protobuf:"fixed64,8,opt,name=price" json:"price"`
	BaseQuantity     float64 `protobuf:"fixed64,9,opt,name=baseQuantity" json:"baseQuantity"`
	BasePercent      float64 `protobuf:"fixed64,10,opt,name=basePercent" json:"basePercent"`
	CurrencyQuantity float64 `protobuf:"fixed64,11,opt,name=currencyQuantity" json:"currencyQuantity"`
	CurrencyPercent  float64 `protobuf:"fixed64,12,opt,name=currencyPercent" json:"currencyPercent"`
	Conditions       string  `protobuf:"bytes,13,opt,name=conditions" json:"conditions"`
...
var fileDescriptor0 = []byte{
	...
	,
}
