...
type OrderServiceClient interface {
	AddOrders(ctx context.Context, in *OrderRequests, opts ...client.CallOption) (*OrderResponse, error)
...
func (c *orderServiceClient) AddOrders(ctx context.Context, in *OrderRequests, opts ...client.CallOption) (*OrderResponse, error) {
...
type OrderServiceHandler interface {
	AddOrders(context.Context, *OrderRequests, *OrderResponse) error
...
func (h *OrderService) AddOrders(ctx context.Context, in *OrderRequests, out *OrderResponse) error {
...
var fileDescriptor0 = []byte{
	...
	,
}
